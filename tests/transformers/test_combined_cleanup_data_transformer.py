class TestCleanupDataTransformer:
    ...
    def test_cleanup_data_with_blanks(
        ...
        assert len(result) == len(expected_result)  # Blank facts should be removed
    ...
    def test_cleanup_data_with_duplicates(
        ...
        assert len(result) == len(expected_result)  # Duplicate facts should be removed
    ...
    def test_cleanup_data_with_whitespaces(
        ...
        assert len(result) == len(expected_result)  # Whitespaces should be cleaned
    ...
    def test_cleanup_data_all_steps_combined(
        ...
        # The result should have no blanks, no duplicates, and no leading/trailing
        # whitespaces
